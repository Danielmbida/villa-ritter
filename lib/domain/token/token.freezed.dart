...
class _$TokenTearOff {
  ...
  _Token call({required UniqueId id, required String token}) {
    return _Token(
      id: id,
      token: token,
    );
...
abstract class $TokenCopyWith<$Res> {
  ...
  $Res call({UniqueId id, String token});
}
...
class _$_Token implements _Token {
  const _$_Token({required this.id, required this.token});
...
abstract class _Token implements Token {
  const factory _Token({required UniqueId id, required String token}) =
      _$_Token;
