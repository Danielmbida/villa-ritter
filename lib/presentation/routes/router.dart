...
import 'package:apptest/presentation/villa/contact_page.dart';
import 'package:apptest/presentation/villa/news_page.dart';
import 'package:apptest/presentation/villa/post_page.dart';
import 'package:apptest/presentation/villa/user_manage_user.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    CustomRoute(page: PostPage,transitionsBuilder: TransitionsBuilders.slideRight),
